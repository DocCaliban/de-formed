...
complexity, use the property names of the object you want to validate. When using state, it is assumed that state is the object containing the property of the validation (e.g. "state" below would be a Dog object).
